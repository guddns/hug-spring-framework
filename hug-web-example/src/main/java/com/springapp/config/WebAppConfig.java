...
import com.springapp.exception.BaseHandlerExceptionResolver;
 ...
 */
@Configuration
@EnableVelocity(resourceLoaderPath = "/WEB-INF/views")
@ComponentScan(basePackages = {"com.springapp.controller", "com.springapp.service"})
